...
import { addReminder, deleteReminder, clearReminders } from '../utils/actions';
...
class App extends Component {
  ...
  render() {
    let clear = this.props.clearReminders;
    return (
      <div className="App">
        <div className="title">
          Reminder Pro
        ...
        <div className="btn btn-danger" onClick={clear}>Clear Reminders</div>
      </div>
    )
  }
}
